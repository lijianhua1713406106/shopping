        ...
        <td>
            <table>
                <tr>
                    <td >
                        <p></p>
                        <img src="${pageContext.request.contextPath}/img/bgimg.png"/>
                    </td>
                    <td>
                        <form style="margin-left: 200px;" action="/LoginServlet">
                                    ...
                                    <td colspan="2">
                                        <span style="color: red">
                                           <%-- <%
                                            ...
                                            <c:if test="${param.message=='pleaselogin'}">
                                                请登录
                                            </c:if>
