...
<%@ page import="com.offcn.shop.bean.Product" %>
    ...
    <tr>
        <td>
            <table width="100%">
                ...
                <tr align="center">
                 <%--   <%
                        List<Product> hotlist = (List<Product>) request.getAttribute("hostList");
                    %>
                    <%
                        for (int i=0;i<hotlist.size();i++){
                      %>
                    <td>
                        <img src="<%=hotlist.get(i).getProMinImg()%>" width="70%"/><br />
                        <font color="red"><%=hotlist.get(i).getShopPrice()%></font><br />
                        <span><%=hotlist.get(i).getProName()%></span>
                ...
                <td>
                    <a href="${PageContext.request.contxtPath}/ProductInfoServlet?proId=${product.proId}">
                ...
                <tr align="center">
                <c:forEach items="${hostList}" var="product" begin="5" end="9">
                ...
                <tr align="center">
                    <c:forEach items="${hostList}" var="product" begin="10" end="14">
